...
import { innings2 } from './innings2';
import { CommonService } from 'src/app/common.service';
import { ISlimScrollOptions, SlimScrollEvent } from 'ngx-slimscroll';
@Component({
  selector: 'app-sinnings2',
  templateUrl: './sinnings2.component.html',
  styleUrls: ['./sinnings2.component.css']
})
export class Sinnings2Component implements OnInit {
 ...
 // console.log("child data",this.childdata);
  ...
  getContactsBasedOnId() {
   ...
   // console.log('in test');
    ...
    this.batsman = this.innings[1].batsmen;
    this.bowler = this.innings[1].bowlers;
    this.wickets = this.innings[1].fallofwickets;
    this.teamfullname= this.innings[1].battingteams.team_full_name
    //console.log(  this.innings[1].battingteams.team_full_name);

    this.legbyes = this.innings[1].extras.byes
    //  // console.log(   this.teamm.leg_byes);
    this.byes = this.innings[1].extras.byes;

    this.noballs = this.innings[1].extras.no_balls;
    this.penalties = this.innings[1].extras.penalties;
    this.totalextra = this.innings[1].extras.total_extras;
    this.wide = this.innings[1].extras.wides;
   ...
   //console.log("this.strikebatsmanin inings 2",this.strikebatsman);
