...
@Component({
  selector: 'app-cinnings2',
  templateUrl: './cinnings2.component.html',
  styleUrls: ['./cinnings2.component.css']
})
export class Cinnings2Component implements OnInit {
  public innings;
  public message;
  ...
  ngOnInit() {
   ...
   // console.log('someInputValue', this.Id);

    //console.log('activated routerd in second componernt', this.Id);
    this.opts = {
  ...
  getsCommentoryBasedOnId() {
    //this.CommonService.getsCommentoryBasedOnId(id).subscribe((data) => {
      this.cchilddata;
      this.array=[];
     // console.log("this.cccdata", this.cchilddata.commentarydetails.data);
      ...
      // this.message=this.innings[1].messages
    ...
    //  console.log('cc2',  this.array);
    //  console.log("Arrayyyyyyyyy",this.array);
